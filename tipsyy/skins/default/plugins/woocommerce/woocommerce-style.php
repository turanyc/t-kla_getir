...
if ( ! function_exists( 'tipsy_woocommerce_get_css' ) ) {
	add_filter( 'tipsy_filter_get_css', 'tipsy_woocommerce_get_css', 10, 2 );
	function tipsy_woocommerce_get_css( $css, $args ) {
...
$fdir = tipsy_get_file_dir( 'plugins/woocommerce/woocommerce-skin.php' );
if ( ! empty( $fdir ) ) {
	require_once $fdir;
}
