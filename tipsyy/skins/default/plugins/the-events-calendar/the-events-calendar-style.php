...
if ( ! function_exists( 'tipsy_tribe_events_get_css' ) ) {
	add_filter( 'tipsy_filter_get_css', 'tipsy_tribe_events_get_css', 10, 2 );
	function tipsy_tribe_events_get_css( $css, $args ) {
