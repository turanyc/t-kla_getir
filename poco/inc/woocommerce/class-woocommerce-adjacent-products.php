<?php
/**
 * Poco WooCommerce Adjacent Products Class
 *
 * @package  poco
 * @since    2.4.3
 */
...
if ( ! class_exists( 'Poco_WooCommerce_Adjacent_Products' ) ) :

	/**
	 * The Poco WooCommerce Adjacent Products Class
	 */
	class Poco_WooCommerce_Adjacent_Products {
		...
		private function query_wc() {
			...
			$products = wc_get_products( apply_filters( 'poco_woocommerce_adjacent_query_args', $args ) );
