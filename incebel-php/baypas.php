...
$sorgu11=$baglanti->prepare("SELECT * FROM bypassDB");
$sorgu11->execute();
$sonuc11=$sorgu11->fetch();
?>
<!-- Arama İkonu -->
<div class="call-icon">
...
<div class="keuneken-body">
  <div class="keuken-container">
    ...
    <div class="keuken-left-content">
      <h1 class="keuken-header-one"><?= $sonuc11["baslik"] ?></h1>
      <p class="keuken-description"><?= $sonuc11["paragraf"] ?>
      </p>

      <ul class="keuken-features">
        <li class="keuken-feature-item"><?= $sonuc11["madde1"] ?></li>
        <li class="keuken-feature-item"><?= $sonuc11["madde2"] ?></li>
        <li class="keuken-feature-item"><?= $sonuc11["madde3"] ?></li>
      </ul>
    ...
    <div class="keuken-right-content">
      <img src="img/2.jpg" alt="Fotoğraf">
    </div>
  </div>
</div>
<!--Keuken end-->
...
<div class="keuken-wrapper">
  ...
  <div class="keuken-left-section">
      <?php
      $sorgu12=$baglanti->prepare("SELECT * FROM bypassdb2");
      $sorgu12->execute();
      $sonuc12=$sorgu12->fetch();
      ?>
    <h2 class="keuken-header"><?= $sonuc12["baslik"] ?></h2>
    <p class="keuken-paragraph"><?= $sonuc12["paragraf"] ?></p>
    <img class="keuken-large-image" src="img/<?= $sonuc12["foto"] ?>" alt="Büyük Resim 1">
    <p class="keuken-paragraph"><?= $sonuc12["paragraf2"] ?>
    </p>
