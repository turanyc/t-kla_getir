...
$sorgu = $baglanti->prepare("SELECT * FROM ikincibolum WHERE id = :id");
$sorgu->execute(['id' => $id]);
$sonuc = $sorgu->fetch();
...
<main>
    <div class="container-fluid px-4">
        <h1 class="mt-4">İkinci Bölüm Güncelleme</h1>
        <ol class="breadcrumb mb-4">
            <li class="breadcrumb-item active">Dashboard</li>
            <li class="breadcrumb-item active">İkinci Bölüm Güncelleme</li>
        </ol>
