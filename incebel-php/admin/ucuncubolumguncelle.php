...
$sorgu = $baglanti->prepare("SELECT * FROM ucuncubolum WHERE id = :id");
$sorgu->execute(['id' => $id]);
$sonuc = $sorgu->fetch();
...
<main>
    <div class="container-fluid px-4">
        <h1 class="mt-4">Üçüncü Bölüm Güncelleme</h1>
        <ol class="breadcrumb mb-4">
            <li class="breadcrumb-item active">Dashboard</li>
            <li class="breadcrumb-item active">Üçüncü Bölüm Güncelleme</li>
        </ol>
