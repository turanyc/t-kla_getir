...
// Market bilgisi (vendor_types.slug = 'market')
$stmt = $pdo->prepare("
...
$marketCategories = $pdo->prepare("
    ...
    ORDER BY mc.name
");
$marketCategories->execute([$market_id]);
$marketCategories = $marketCategories->fetchAll();
...
<head>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        /* ===== MARKET ALT-KATEGORİ BUTONLARI (Tema Uyumlu) ===== */
...
<div class="container">
    ...
    <header class="main-header">
        <div class="logo-section">
            <a href="../index.php" style="text-decoration: none; color: inherit;"><h1><i class="fas fa-shopping-basket"></i> Tıkla Gelir</h1></a>
    ...
    <div class="main-cat-bar">
        ...
        ?>
            <a href="<?= $link ?>" class="main-cat-btn <?= $mc['slug']==='market' ? 'active' : '' ?>">
        ...
        <div class="products-grid">
            <?php foreach ($items as $item): ?>
                <div class="product-card">
                    ...
                    <button class="add-to-cart" onclick="addToCart(<?= $item['id'] ?>, '<?= htmlspecialchars($item['name']) ?>', <?= $item['price'] ?>, <?= $market_id ?>)"><i class="fas fa-cart-plus"></i> Sepete Ekle</button>
                </div>
            <?php endforeach; ?>
        </div>
    <?php endif; ?>
