...
?>
<head>
  <meta name="description" content="İnşaat projeleriniz için sağlam ve güvenilir dolgu çözümleri sunuyoruz. Dolgu çalışmalarımızda kaliteyi ve dayanıklılığı ön planda tutarak zeminin stabilitesini garanti altına alıyoruz.">
</head>
<!-- Arama İkonu -->
<div class="call-icon">
