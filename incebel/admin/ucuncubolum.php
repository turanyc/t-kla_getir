...
$sorgu = $baglanti->prepare("SELECT * FROM ucuncubolum");
$sorgu->execute();
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['guncelle'])) {
    ...
    if (!empty($_POST["baslik"]) && !empty($_POST["paragraf"])) {
        ...
        // Güncelleme işlemi
        $guncelle = $baglanti->prepare("UPDATE ucuncubolum SET foto = :foto, baslik = :baslik, paragraf = :paragraf WHERE id = :id");
            ...
            echo "<script>
                document.addEventListener('DOMContentLoaded', function() {
                    Swal.fire({
                        ...
                        window.location.href = 'ucuncubolum.php';
                    });
                });
            </script>";
        } else {
...
<main>
    <div class="container-fluid px-4">
        <h1 class="mt-4">Üçüncü Bölüm</h1>
        <ol class="breadcrumb mb-4">
            <li class="breadcrumb-item active">Dashboard</li>
            <li class="breadcrumb-item active">Üçüncü Bölüm</li>
        </ol>
        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                <form method="post" enctype="multipart/form-data">
                    ...
                    <a href="ucuncubolum.php" class="btn btn-secondary">İptal</a>
                </form>
            </div>
        </div>
        <?php else: ?>
