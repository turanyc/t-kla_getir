...
$sorgu19=$baglanti->prepare("SELECT * FROM bahcedb");
$sorgu19->execute();
$sonuc19=$sorgu19->fetch();
?>
<head>
<meta name="description" content="Bahçe düzenlemelerinde ihtiyaç duyulan kaliteli toprağı temin ediyor, projelerinize uygun çözümler sunuyoruz. Doğal yapısını koruyan, besin değeri yüksek ve çevre dostu topraklarımız, bitkilerinizin sağlıklı gelişimi için idealdir.">
</head>
<!-- Arama İkonu -->
<div class="call-icon">
...
<div class="keuken-wrapper">
  ...
  <div class="keuken-left-section">
      <?php
      $sorgu20=$baglanti->prepare("SELECT * FROM bahcedb2");
      $sorgu20->execute();
